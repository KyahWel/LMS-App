                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(24.0),
                        color: Color(0xFF003E6D), // set the background color here
                      ),
                      child: Row(
                        children: [
                          SizedBox(width: 25.0),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(Color(0xFF003E6D)),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 16.0),
                  Text(
                    'Lets break down the code to understand each line: #include <stdio.h> The function used for generating output is defined in stdio.h. In order to use the printf function, we need to first include the required file, also called a header file.',
                    style: TextStyle(
                      fontSize: 20.0,
                      color: Color(0xFF003E6D),
                      fontWeight: FontWeight.bold,
