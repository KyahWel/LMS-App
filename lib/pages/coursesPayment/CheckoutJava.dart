...
class CheckoutJavaPage extends StatefulWidget {
  const CheckoutJavaPage({super.key});

  @override
  State<CheckoutJavaPage> createState() => _CheckoutJavaPageState();
}

class _CheckoutJavaPageState extends State<CheckoutJavaPage> {
  @override
